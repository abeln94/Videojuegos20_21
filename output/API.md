...
* `attackItemWeight`: Weight of the attack items behaviour (see npc/attackItems). Used when randomly picking an action for the IA. If attackItems is defined this is 1 by default, 0 otherwise.
